    ...
    $.getJSON("/api/Budget/" + city, function (data) {
        ...
        function arrayMaker(a, x) {
            ...
            for (var obj in a) {
                ...
                } else if (x.Categorie.SubCategorieen == null) {
                    if (x.Categorie.CategorieId == a[obj].Categorie.CategorieId) {
                        arrNew.push(a[obj]);
                    }
                } else {
        ...
        function makeArc(input, radius, innerRadius) {
            ...
            function click(d, i) {
                if (d3.select(this.parentNode).attr("class") == "open") { // enkel klasse open is klikbaar
                    ...
                    } else if (d3.selectAll("g").size() == 3) {
                        makeArc(arrayMaker(arr[5], input[i]), radius * 1.2, radius);
                    }
        ...
        if (arr.length != 0) {
            makeArc(arrayMaker(arr[4], null), r, ir); // children selecteren via [1] (kan beter!?)
        } else {
